The program is designed to manage vehicle access in a smart parking system. It monitors the entry and exit of vehicles and calculates the total time each vehicle spends in the parking lot.
